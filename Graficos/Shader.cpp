...
{
	//Aquí se va a guardar el texto del vertex shader.
	...
	{
		// Declaramos un string que irá tomando el valor de cada linea de texto del archivo.
		string linea = "";
		...
		cout << "No se pudo abrir el archivo, chaval: " << rutaFragment;
		exit(EXIT_FAILURE);
	}
	...
	//Aquí se va a guardar el texto del fragment shader.
	string codigoFragmentShader;


	//Declara input stream para leer archivo del fragment shader.
